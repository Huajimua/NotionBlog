...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || '欢迎来到Huajiの妙妙屋',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Huaji', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '去看看奇奇怪怪的页面吧？如果你有密码的话——', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion-blog-zeta-ebon.vercel.app/', // 网站地址
